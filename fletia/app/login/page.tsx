      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .stars{position:absolute;inset:0;background:
          radial-gradient(1px 1px at 12% 22%, #cfe4ff 50%, transparent 60%),
          radial-gradient(1px 1px at 32% 12%, #cfe4ff 50%, transparent 60%),
          radial-gradient(1.5px 1.5px at 56% 28%, #fff 50%, transparent 60%),
          radial-gradient(1px 1px at 78% 8%, #cfe4ff 50%, transparent 60%),
          radial-gradient(1px 1px at 88% 34%, #cfe4ff 50%, transparent 60%),
          radial-gradient(1px 1px at 22% 38%, #b5d5ff 50%, transparent 60%),
          radial-gradient(1.5px 1.5px at 6% 6%, #fff 50%, transparent 60%),
          radial-gradient(1px 1px at 70% 18%, #cfe4ff 50%, transparent 60%);
          opacity:.55}
        .stars.twinkle{animation:twinkle 4s ease-in-out infinite alternate}
        @keyframes twinkle{from{opacity:.3}to{opacity:.7}}
        .horizon-glow{position:absolute;left:-10%;right:-10%;top:60%;height:200px;
          background:radial-gradient(60% 100% at 30% 100%, rgba(255,122,77,0.14), transparent 60%),
            radial-gradient(40% 100% at 70% 100%, rgba(255,122,77,0.1), transparent 60%);
        ...
        .truck-bg img{
          position:absolute;
          top:-8%; left:-12%;
          width:124vw; height:116vh;
          object-fit:cover;
          pointer-events:none;
          filter:blur(1px) saturate(1.0) brightness(0.95) contrast(1.05);
          animation:driveby 28s ease-in-out infinite;
          will-change:transform, filter;
        }
        .truck-bg::after{content:"";position:absolute;inset:0;
          background:
            linear-gradient(180deg, rgba(10,10,10,0.25) 0%, rgba(10,10,10,0.12) 35%, rgba(10,10,10,0.30) 70%, rgba(10,10,10,0.92) 100%),
            linear-gradient(90deg, rgba(10,10,10,0.55) 0%, rgba(10,10,10,0.05) 35%, rgba(10,10,10,0.0) 55%, rgba(10,10,10,0.40) 100%),
            radial-gradient(50% 40% at 30% 50%, rgba(10,10,10,0.55), transparent 80%);
          pointer-events:none}
        .truck-bg::before{content:"";position:absolute;inset:0;
          background:repeating-linear-gradient(0deg, rgba(255,255,255,0.015) 0 1px, transparent 1px 3px);
          mix-blend-mode:overlay;pointer-events:none}
        @keyframes driveby{
          0%, 100% {transform:translate3d(-2%, 0px, 0) scale(1.08)}
          25%       {transform:translate3d(-4%, -2px, 0) scale(1.10)}
          50%       {transform:translate3d(-5%, -3px, 0) scale(1.12)}
          75%       {transform:translate3d(-3%, -1px, 0) scale(1.10)}
        }
        .wheel-spin{transform-origin:center;animation:spin 0.6s linear infinite}
        @keyframes spin{to{transform:rotate(360deg)}}

        .shell{position:relative;z-index:5;max-width:1240px;margin:0 auto;padding:0 32px}
        nav.top{display:flex;align-items:center;justify-content:space-between;padding:26px 0 0}
        ...
        .btn.ghost{color:var(--ink);border-color:var(--line-strong);background:rgba(255,255,255,0.02);transition:transform .25s cubic-bezier(.22,.61,.36,1), background .25s ease, border-color .25s ease, color .25s ease, box-shadow .25s ease}
        ...
        h1.hero-title{font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:clamp(48px, 7.2vw, 104px);line-height:0.96;letter-spacing:-0.035em;margin:0 0 28px;max-width:1100px;text-wrap:balance;color:var(--ink)}
        ...
        .lead b{color:var(--ink);font-weight:600;opacity:1}
        ...
        .section-title{font-family:'Space Grotesk',sans-serif;font-size:clamp(36px, 4.4vw, 56px);font-weight:600;line-height:1.02;letter-spacing:-0.03em;margin:0;max-width:720px;text-wrap:balance}
        .section-sub{color:var(--ink-2);font-size:16px;max-width:380px;line-height:1.55;margin:0}

        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px}
        .feat{position:relative;padding:30px 26px 32px;border-radius:18px;
          background:linear-gradient(180deg, rgba(20,20,20,0.55), rgba(20,20,20,0.30));
          border:1px solid rgba(255,255,255,0.10);
          overflow:hidden;
          backdrop-filter:blur(14px) saturate(1.1);
          -webkit-backdrop-filter:blur(14px) saturate(1.1);
          box-shadow:0 4px 24px -8px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.06);
          animation:floatcard 6s ease-in-out infinite;
          transition:transform .35s cubic-bezier(.22,.61,.36,1), border-color .25s ease, box-shadow .35s ease, background .35s ease}
        .feat:nth-child(2){animation-delay:-1s}
        .feat:nth-child(3){animation-delay:-2s}
        .feat:nth-child(4){animation-delay:-3s}
        .feat:nth-child(5){animation-delay:-4s}
        .feat:nth-child(6){animation-delay:-5s}
        @keyframes floatcard{0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)}}
        .feat:hover{animation-play-state:paused;transform:translateY(-8px) scale(1.015);border-color:var(--cyan);box-shadow:0 0 0 1px var(--cyan), 0 24px 60px -18px rgba(255,122,77,0.55), inset 0 1px 0 rgba(255,255,255,0.10);background:linear-gradient(180deg, rgba(30,20,18,0.65), rgba(20,20,20,0.40))}
        .feat:hover::after{content:"";position:absolute;inset:0;border-radius:18px;background:radial-gradient(120% 80% at 0% 0%, rgba(255,122,77,0.10), transparent 55%);pointer-events:none}
        ...
        .how-copy h2{font-family:'Space Grotesk',sans-serif;font-size:clamp(34px, 4vw, 50px);font-weight:600;line-height:1.02;letter-spacing:-0.03em;margin:0 0 20px;text-wrap:balance}
        ...
        .console .body .k{color:var(--cyan)}
        .console .body .a{color:var(--amber)}
        .console .body .g{color:var(--good)}
        .console .body .m{color:var(--ink-3)}
        .console .body .h{color:var(--ink);font-weight:500}
        ...
        .calc-card .row .lbl{color:var(--ink-3);font-size:12px}
        .calc-card .row .val{color:var(--ink);font-size:13px}
        ...
        .plan{position:relative;padding:34px 28px 32px;border-radius:22px;
          background:linear-gradient(180deg, rgba(20,20,20,0.7), rgba(20,20,20,0.45));
          border:1px solid rgba(255,255,255,0.10);
          backdrop-filter:blur(14px) saturate(1.1);
          -webkit-backdrop-filter:blur(14px) saturate(1.1);
          overflow:hidden;
        ...
        .plan .pnote{margin-top:14px;text-align:center;font-family:'JetBrains Mono',monospace;font-size:11px;color:var(--ink);opacity:0.55;letter-spacing:0.08em}
        @media (max-width: 920px){.plans{grid-template-columns:1fr;gap:14px}}
        ...
        @media (max-width: 640px){
          ...
          .hero{padding:64px 0 56px;min-height:80vh}
          .truck-bg img{animation-duration:14s;filter:blur(1px) saturate(1.0) brightness(0.92) contrast(1.05)}
        }
        @media (prefers-reduced-motion: reduce){
          .truck-bg img,.eyebrow .dot{animation:none !important}
      ...
      <div className="shell">
        ...
        <section className="hero">
          <span className="eyebrow">
            ...
            INTELIGENCIA ARTIFICIAL PARA TU FLOTA DE CAMIONES.
          </span>
          <h1 className="hero-title">
            Calculá el costo real<br/>
            de cada <em>viaje</em>
          </h1>
          <p className="lead">
            FletIA calcula cuánto te cuesta cada flete antes de salir. Con IA que aprende de tu camión y te dice si el viaje es rentable — En tiempo real y desde tu Celular o Portátil.
          </p>
          <div className="cta-row">
            ...
            <div className="cta-meta" style={{color:'rgb(247,250,246)'}}>✓ Sin tarjeta &nbsp;·&nbsp; ✓ Cancelás cuando querés</div>
          </div>
          ...
          <div className="stats reveal-stagger">
            ...
            <div className="stat">
              <div className="k">0<span className="u">hw</span></div>
              <div className="l">Sin GPS ni dispositivos</div>
            </div>
            <div className="stat">
              <div className="k">∞</div>
              <div className="l">Camiones y viajes</div>
            </div>
            <div className="stat">
              <div className="k">15d</div>
              <div className="l">Prueba completa gratis</div>
            </div>
          </div>
        </section>
        ...
        <section className="section" id="features">
          ...
          <div className="feat-grid reveal-stagger">
            <div className="feat">
              ...
              <div className="ico">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8 7h8M8 11h8M8 15h5"/></svg>
              </div>
              <h3>Cálculo antes del viaje</h3>
              <p style={{color:'rgb(228,226,226)'}}>Ingresás origen, destino, peso y terreno. Te devolvemos el costo exacto en combustible antes de arrancar el motor.</p>
            </div>

            <div className="feat">
              <div className="num">02</div>
              <div className="ico">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a4 4 0 0 0-4 4v1a3 3 0 0 0-3 3v2a3 3 0 0 0 3 3v1a4 4 0 0 0 8 0v-1a3 3 0 0 0 3-3v-2a3 3 0 0 0-3-3V7a4 4 0 0 0-4-4Z"/><path d="M9 11h.01M15 11h.01M9 15h6"/></svg>
              </div>
              <h3>IA que aprende</h3>
              <p style={{color:'rgb(235,233,233)'}}>Cada viaje que registrás enseña al modelo. Con el tiempo las estimaciones se afinan al consumo real de tu camión.</p>
            </div>

            <div className="feat amber">
              <div className="num">03</div>
              <div className="ico">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 6H9.5a3.5 3.5 0 1 0 0 7H14.5a3.5 3.5 0 1 1 0 7H7"/></svg>
              </div>
              <h3>Rentabilidad real</h3>
              <p style={{color:'rgb(235,234,234)'}}>Comparamos lo que cobrás contra el costo real del flete. Sabés al instante si ganás o perdés plata.</p>
            </div>

            <div className="feat">
              <div className="num">04</div>
              <div className="ico">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 17V8a2 2 0 0 1 2-2h9v11"/><path d="M14 10h4l3 3v4h-2"/><circle cx="7.5" cy="17.5" r="2.2"/><circle cx="17.5" cy="17.5" r="2.2"/></svg>
              </div>
              <h3>Por camión y por ruta</h3>
              <p style={{color:'rgb(230,229,229)'}}>Cada unidad tiene su perfil de consumo. La IA aprende cada camión por separado.</p>
            </div>
            ...
            <div className="feat">
              ...
              <h3>Hecho para tu Empresa</h3>
              <p style={{color:'rgb(231,231,231)'}}>Pensado para PyMEs, transportistas independientes y más.</p>
            </div>

            <div className="feat">
              <div className="num">06</div>
              <div className="ico">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="7" y="2" width="10" height="20" rx="2"/><path d="M11 18h2"/></svg>
              </div>
              <h3>Sin hardware</h3>
              <p style={{color:'rgb(220,219,219)'}}>No necesitás instalar GPS, OBD ni dispositivos. Funciona desde el celular o la PC — entrás y listo.</p>
            </div>
          </div>
        </section>
        ...
        <section className="section" id="how" style={{paddingBottom:'48px'}}>
          <div className="how">
            <div className="how-copy reveal">
              ...
              <div className="how-steps">
                <div className="how-step">
                  ...
                  <div>
                    <div className="t">Cargás el viaje</div>
                    <div className="d">Origen, destino, peso y qué camión vas a usar. 15 segundos.</div>
                  </div>
                </div>
                <div className="how-step">
                  <div className="n">2</div>
                  <div>
                    <div className="t">La IA calcula</div>
                    <div className="d">Combina distancia, consumo aprendido y precio actual del gasoil.</div>
                  </div>
                </div>
                <div className="how-step">
                  <div className="n">3</div>
                  <div>
                    <div className="t">Decidís con datos</div>
                    <div className="d">Te muestra costo, margen y si el flete que te ofrecen conviene.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="console reveal">
              <div className="bar">
                <span className="dot"></span><span className="dot"></span><span className="dot g"></span>
                <span className="ttl">fletia • nuevo viaje</span>
              </div>
              <div className="body">
        ...
        <section className="section" id="planes" style={{paddingTop:'32px',paddingBottom:'80px'}}>
          <div className="section-head reveal" style={{justifyContent:'center',textAlign:'center',flexDirection:'column',alignItems:'center',marginBottom:'48px'}}>
            <div>
              <div className="section-tag" style={{textAlign:'center'}}>// Planes</div>
              <h2 className="section-title" style={{textAlign:'center'}}>Elegí el plan que se adapta a tu flota</h2>
              <p className="section-sub" style={{textAlign:'center',maxWidth:'520px',margin:'16px auto 0',color:'rgb(246,240,240)'}}>Desde un camión hasta una flota completa. Empezá gratis y escalá cuando lo necesites.</p>
            </div>
          </div>
        ...
        <section className="section" id="pricing" style={{paddingTop:'32px'}}>
          <div className="section-head reveal" style={{justifyContent:'center',textAlign:'center',flexDirection:'column',alignItems:'center',marginBottom:'36px'}}>
            <div>
              <div className="section-tag" style={{textAlign:'center',color:'rgb(253,100,48)'}}>// Precio simple</div>
            </div>
          </div>
