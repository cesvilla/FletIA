...
const SECCIONES = [
  {
    ...
    c: 'FletIA (César Villa), con domicilio en la provincia de Tucumán, Argentina, es responsable del tratamiento de los datos personales recolectados a través de la plataforma. Contacto: hola@flet-ia.com o WhatsApp +54 9 381 565-7595.',
  },
  {
