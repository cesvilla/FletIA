    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        .truck-bg img{position:absolute;top:-8%;left:-12%;width:124vw;height:116vh;object-fit:cover;pointer-events:none;filter:blur(1px) saturate(1.0) brightness(0.95) contrast(1.05);animation:driveby 28s ease-in-out infinite;will-change:transform,filter}
        .truck-bg::after{content:"";position:absolute;inset:0;background:linear-gradient(180deg, rgba(10,10,10,0.25) 0%, rgba(10,10,10,0.12) 35%, rgba(10,10,10,0.30) 70%, rgba(10,10,10,0.92) 100%),linear-gradient(90deg, rgba(10,10,10,0.55) 0%, rgba(10,10,10,0.05) 35%, rgba(10,10,10,0.0) 55%, rgba(10,10,10,0.40) 100%),radial-gradient(50% 40% at 30% 50%, rgba(10,10,10,0.55), transparent 80%);pointer-events:none}
        ...
        @keyframes driveby{0%,100%{transform:translate3d(-2%,0px,0) scale(1.08)}25%{transform:translate3d(-4%,-2px,0) scale(1.10)}50%{transform:translate3d(-5%,-3px,0) scale(1.12)}75%{transform:translate3d(-3%,-1px,0) scale(1.10)}}
        ...
        @media(max-width:920px){.feat-grid{grid-template-columns:1fr 1fr}.how{grid-template-columns:1fr;gap:36px}.stats{grid-template-columns:1fr 1fr;gap:0}.stat{padding:14px 16px;border-bottom:1px solid var(--line)}.stat:nth-child(odd){border-right:1px solid var(--line)}.stat:nth-child(2){border-right:none}}
        @media(max-width:640px){.shell{padding:0 20px}.feat-grid{grid-template-columns:1fr}nav.top .actions .btn.ghost{display:none}.hero{padding:64px 0 56px;min-height:80vh}}
        ...
        <section className="section" id="features">
          ...
          <div className="feat-grid reveal-stagger">
            <div className="feat">
              ...
              <div className="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M8 7h8M8 11h8M8 15h5"/></svg></div>
              <h3>Cálculo antes del viaje</h3>
              <p>Ingresás origen, destino, peso y terreno. Te devolvemos el costo exacto en combustible antes de arrancar el motor.</p>
            </div>
            <div className="feat">
              <div className="num">02</div>
              <div className="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a4 4 0 0 0-4 4v1a3 3 0 0 0-3 3v2a3 3 0 0 0 3 3v1a4 4 0 0 0 8 0v-1a3 3 0 0 0 3-3v-2a3 3 0 0 0-3-3V7a4 4 0 0 0-4-4Z"/><path d="M9 11h.01M15 11h.01M9 15h6"/></svg></div>
              <h3>IA que aprende</h3>
              <p>Cada viaje que registrás enseña al modelo. Con el tiempo las estimaciones se afinan al consumo real de tu camión.</p>
            </div>
            <div className="feat amber">
              <div className="num">03</div>
              <div className="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 6H9.5a3.5 3.5 0 1 0 0 7H14.5a3.5 3.5 0 1 1 0 7H7"/></svg></div>
              <h3>Rentabilidad real</h3>
              <p>Comparamos lo que cobrás contra el costo real del flete. Sabés al instante si ganás o perdés plata.</p>
            </div>
            <div className="feat">
              <div className="num">04</div>
              <div className="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 17V8a2 2 0 0 1 2-2h9v11"/><path d="M14 10h4l3 3v4h-2"/><circle cx="7.5" cy="17.5" r="2.2"/><circle cx="17.5" cy="17.5" r="2.2"/></svg></div>
              <h3>Por camión y por ruta</h3>
              <p>Cada unidad tiene su perfil de consumo. La IA aprende cada camión por separado.</p>
            </div>
            <div className="feat">
              <div className="num">05</div>
              <div className="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><path d="M3 12h18M12 3a14 14 0 0 1 0 18M12 3a14 14 0 0 0 0 18"/></svg></div>
              <h3>Hecho para tu Empresa</h3>
              <p>Pensado para PyMEs, transportistas independientes y más.</p>
            </div>
            <div className="feat">
              <div className="num">06</div>
              <div className="ico"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="7" y="2" width="10" height="20" rx="2"/><path d="M11 18h2"/></svg></div>
              <h3>Sin hardware</h3>
              <p>No necesitás instalar GPS, OBD ni dispositivos. Funciona desde el celular o la PC.</p>
            </div>
          </div>
        </section>
